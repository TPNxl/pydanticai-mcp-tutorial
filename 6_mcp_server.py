...
from utils.pdg import pdg_lookup as _pdg_lookup

mcp = FastMCP("physics-tools")

# MCP LLM descriptions are generated "automatically" from this @mcp.tool annotation and the Python docstrings
# This means commenting your code is super important!
@mcp.tool()
